...
function Add() {
  ...
  return (
    <>
      <button onClick={handleShow} style={{ textDecoration: 'none' }} className='btn btn-link text-warning d-flex align-items-center fw-bolder'> <i style={{ height: '34px' }} className="fa-solid fa-plus fa-2x me-2"></i>
        Add Project</button>
      <Modal size='lg'
        show={show}
        onHide={handleClose}
